...
阶段写入与 Pipeline 表面以 `docs/CONSTITUTION.md` §4.2 / §5 与 `policies/change_stage.yaml` 为准，不再另立 `FS-KOL-006` / `FS-KOL-010`。管理端配套套件见 `docs/21-admin-employee-page-roles.md`；本目录不新增 Admin UX ID。
