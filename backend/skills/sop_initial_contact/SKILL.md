---
id: sop_initial_contact
title: SOP · 初步接触
description: 初步接触 的版本化 SOP。只准备资料和下一步，不自动发信，不自动改正式阶段。
category: 线索
profile: lead
output: task_result
...
sop_id: INITIAL_CONTACT
version: 2026-09-08.1

对照 `backend/src/stages.ts` 的主阶段 INITIAL_CONTACT。Codex app-server 按本 Skill 展示当前步骤、需要输入、完成证据和下一步。不发信、不改阶段。
