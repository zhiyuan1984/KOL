...
| 契约编译器 | `config/*.yaml`、`agents/kol/manifest.yaml`、`workflows/*.yaml`、`policies/*.yaml`、`schemas/*.json`、`evals/kol/core.jsonl`、`backend/scripts/validate-contracts.mjs` | 试点契约可解析；安培时代组织绑定已确认；仍未完成全平台 Agent registry |
