...
20. `19-ui-ux-constitution.md`：员工端体验宪法（核心闭环、四页分工、员工侧栏 IA、并列能力面与 Agent/任务解耦、`/agents` 专家中心=召唤岗位专家、Agent 表面、结果优先）
...
- `DECISIONS.md`：跨文档架构决策记录（近期：ADR-015 并列能力面；ADR-016 专家中心 = 召唤岗位专家）。
