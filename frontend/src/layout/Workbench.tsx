    ...
    >
      ...
      <aside className={"sidebar" + (mobileOpen ? " mobile-open" : "")}>
        ...
        <nav className="nav-group" aria-label="智能体">
          ...
          <NavLink to="/agents" className={({ isActive }) => "nav-link" + (isActive ? " active" : "")} data-nav="agents" title="我的智能体" onClick={() => setMobileOpen(false)}>
          ...
          <NavLink to="/teams" className={({ isActive }) => "nav-link" + (isActive ? " active" : "")} data-nav="teams" title="智能体团队" onClick={() => setMobileOpen(false)}>
